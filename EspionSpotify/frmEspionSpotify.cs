...
namespace EspionSpotify
{
    public sealed partial class FrmEspionSpotify : MetroForm, IFrmEspionSpotify
    {
        ...
        public void Init()
        {
            ...
            chkRecordOnlyAds.Enabled = Settings.Default.RecordEverythingEnabled;
            ...
            chkRecordOnlyAds.Checked = Settings.Default.RecordOnlyAdsEnabled;
            ...
            _userSettings.RecordOnlyAdsEnabled = Settings.Default.RecordOnlyAdsEnabled;
        ...
        private void SetLanguage()
        {
            ...
            chkRecordOnlyAds.Text = Rm.GetString(I18nKeys.LblRecordAds);
        ...
        private void TgRecordEverything_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chkRecordOnlyAds.Enabled = tgRecordEverything.Checked;
            ...
            Task.Run(async () => await _analytics.LogAction(
                $"record-everything?enabled={tgRecordEverything.GetPropertyThreadSafe(c => c.Checked)}&including-ads={_userSettings.RecordOnlyAdsEnabled}"));
        }

        private void ChkRecordAds_CheckedChanged(object sender, EventArgs e)
        {
            if (Settings.Default.RecordOnlyAdsEnabled == chkRecordOnlyAds.Checked) return;

            _userSettings.RecordOnlyAdsEnabled = chkRecordOnlyAds.Checked;
            Settings.Default.RecordOnlyAdsEnabled = chkRecordOnlyAds.Checked;
            Settings.Default.Save();

            Task.Run(async () => await _analytics.LogAction(
                $"record-everything?enabled={_userSettings.RecordEverythingEnabled}&including-ads={chkRecordOnlyAds.GetPropertyThreadSafe(c => c.Checked)}"));
        }
