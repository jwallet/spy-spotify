...
{
    public sealed class AudioMMDevicesManager : IMMNotificationClient, IDisposable
    {
        private MMDevice _defaultEndpointVolumeController;
        private bool _disposed;

        internal bool VolumeNotificationEmitted;
        ...
        public MMDevice AudioEndPointDevice
        {
            get
            {
                ...
                return deviceName != null && AudioMMDevices != null
                    ? AudioMMDevices.GetDeviceSafeException(deviceName, true)
                    : null;
            }
        }
        ...
        public void OnDeviceStateChanged(string deviceId, DeviceState newState)
        {
            switch (newState)
            {
                ...
                default:
                    if (AudioEndPointDeviceNames.IncludesKey(deviceId)) AudioEndPointDeviceNames.Remove(deviceId);
                    break;
            }
